    ...
    var SileroLegacy = class {
      constructor(ortInstance, _session, _h, _c, _sr) {
        ...
        this.process = async (audioFrame) => {
          ...
          this._h = out["hn"];
          this._c = out["cn"];
          const [isSpeech] = (_a2 = out["output"]) == null ? void 0 : _a2.data;
  ...
  "node_modules/@ricky0123/vad-web/dist/real-time-vad.js"(exports2) {
    ...
    var AudioNodeVAD = class _AudioNodeVAD {
      static async new(ctx, options = {}) {
        ...
        const audioNodeVAD = new _AudioNodeVAD(ctx, fullOptions, frameProcessor);
      ...
      constructor(ctx, options, frameProcessor) {
        ...
        this.destroy = () => {
          ...
          (_a = this.gainNode) == null ? void 0 : _a.disconnect();
        };
        ...
        if (hasAudioWorklet) {
          try {
            ...
            this.audioNode.port.onmessage = async (ev) => {
              var _a;
              switch ((_a = ev.data) == null ? void 0 : _a.message) {
...
onnxruntime-web/dist/ort-web.min.js:
  ...
  *)
*/
//# sourceMappingURL=@ricky0123_vad-web.js.map
